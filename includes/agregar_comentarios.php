...
$a_multi_comentarios = array( 'id_producto' => $_REQUEST['banner'], 'mail'=>$_REQUEST['mail'],'comentario'=>$_REQUEST['comentario'], 'valoracion' => $_REQUEST['valoracion']); //agrega nueva info al array
